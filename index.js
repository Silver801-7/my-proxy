...
app.get('/', async (req, res) => {
  ...
  try {
    ...
    /*
     * هذه هي الرؤوس الموجودة في كودك الأصلي.
     * إذا أردت اختبار المصدر بدون رؤوس المتصفح المصطنعة، احذف Origin
     * وSec-Fetch-* مؤقتاً، لكن لا تغيّر كل شيء في نفس الوقت أثناء الاختبار.
     */
    ...
    try {
      ...
      res.set({
        ...
        'X-Proxy-Error': errorMessage.slice(0, 180),
      });
